...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    if (section==0) {
        ...
        [attributedString addAttribute:NSForegroundColorAttributeName value:AppMainColor range:[attention.titleLabel.text rangeOfString:modal.invitednum?modal.invitednum:str]];
        [attention setAttributedTitle:attributedString forState:UIControlStateNormal];
